...
export const PHOTOGRAPHER_AUTH_DEFAULT = '未获取'
export const PHOTOGRAPHER_AUTH_NONE = '未申请'
export const PHOTOGRAPHER_AUTH_PENDING = '审核中'
export const PHOTOGRAPHER_AUTH_APPROVE = '审核通过'
export const PHOTOGRAPHER_AUTH_DISAPPROVE = '审核拒绝'
...
export const PhotographerAuthStore = Reflux.createStore({
